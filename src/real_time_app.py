...
model_beggining_rgb = keras.Sequential(
    [
...
model_beggining_depth = keras.Sequential(
    [
        layers.Conv3D(16, kernel_size=(3, 3, 4), input_shape=(3, 120, 160, 3), strides=(1, 1, 1),
                      padding='same',
                      activation='relu'),
...
model_middle_rgb = keras.Sequential(
    [
...
model_middle_depth = keras.Sequential(
    [
        layers.Conv3D(16, kernel_size=(3, 3, 4), input_shape=(4, 120, 160, 3), strides=(1, 1, 1),
                      padding='same',
                      activation='relu'),
...
model_end_rgb = keras.Sequential(
    [
        layers.Conv3D(16, kernel_size=(3, 3, 4), input_shape=(3, 120, 160, 3), strides=(1, 1, 1),
                      padding='same',
                      activation='relu'),
...
model_end_depth = keras.Sequential(
    [
        layers.Conv3D(16, kernel_size=(3, 3, 4), input_shape=(3, 120, 160, 3), strides=(1, 1, 1),
                      padding='same',
                      activation='relu'),
...
def main_app():
    model_beggining_rgb.load_weights('video_rgb_reduced_beginning_weights.h5')
    model_beggining_depth.load_weights('video_depth_reduced_beginning_weights.h5')
    model_middle_rgb.load_weights('video_rgb_reduced_middle_weights.h5')
    model_middle_depth.load_weights('video_depth_reduced_middle_weights.h5')
    model_end_rgb.load_weights('video_rgb_reduced_end_weights.h5')
    model_end_depth.load_weights('video_depth_reduced_end_weights.h5')
