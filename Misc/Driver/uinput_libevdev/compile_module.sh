...
arm-linux-gnueabihf-gcc -c $(shell pkg-config --cflags --libs libevdev) -Wall -Wextra -Werror -pedantic python_module.c python_module_wrap.c -I/usr/include/python3.7m
